...
// En Prod, Nginx mapea '/bt/api/' al contenedor de BT
window.API_URL = window.isLocal ? 'http://localhost:3000/api' : '/bt/api';
window.ASSETS_BASE = window.isLocal ? 'http://localhost:3000' : '/bt';
